...
extern void setFilenameCB(void (*fn)(const char*, uint8_t));
extern void setFileSizeCB(void (*fn)(uint16_t));
extern void setFileTypeCB(void (*fn)(const char*, uint8_t));
extern void setDataCB(void (*fn)(const uint8_t*, uint16_t));
extern void setDataEndCB(void(*fn)(void));
